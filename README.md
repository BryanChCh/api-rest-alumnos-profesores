...
Servidor Linux (Amazon Linux 2) alojando la API con Node.js y Express.

RDS (Database)

Base de datos relacional MySQL para la persistencia de datos principales (Alumnos/Profesores). Gestión mediante Sequelize ORM.

S3 (Storage)

Almacenamiento de objetos para la subida y gestión de fotos de perfil de usuarios.

DynamoDB (NoSQL)

Base de datos NoSQL de alta velocidad para la gestión de sesiones de usuario y tokens de autenticación.

SNS (Messaging)

Sistema de notificaciones Pub/Sub para el envío de reportes de calificaciones por correo electrónico.
